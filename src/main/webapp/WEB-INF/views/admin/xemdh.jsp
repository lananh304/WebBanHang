...
<div class = "container-fluid padding0">
    ...
    <div id = "main">
        ...
        <h1><span class = "glyphicon glyphicon-folder-open addtop" aria-hidden = "true"></span>&nbsp;&nbsp;Chi tiết đơn hàng</h1>
        <div id = "sub-main">
            <div class = "row">
            ...
            <div class = "row margin0 space-top">
				...
				<div class = "table-responsive quantri">
					<table class = "table table-striped table-bordered">
						...
						<c:forEach var="item" items="${donhangdelete}" >
						<tr>
							<td>${item.id}</td>
								<td>${item.id_product}</td>
								<td>${item.name_product}</td>
								<td><img  style="width: 100px;height: 100px" class="img-responsive" src="<c:url value="/assets/user/images/truyentranh/${item.img_product}"/>" alt=""/></td>
							<td>${item.quanty}</td>
					    ...
					    <div class = "btntrolai" style="text-align: center">
									<a href = "<c:url value="/donhang"/>" style="color: white">Trở lại</a>
								</div>
				</div>
