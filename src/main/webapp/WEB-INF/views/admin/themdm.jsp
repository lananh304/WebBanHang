...
<body>
		...
		<div id="main">
			<nav class="navbar navbar-default">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown active"><c:if
							test="${ not empty LoginInfo }">



							<a href="#" class="dropdown-toggle" data-toggle="dropdown"
								role="button" aria-haspopup="true" aria-expanded="false">Chào!
								${LoginInfo.username }<span class="caret caret-fix"></span>
							</a>
							<ul class="dropdown-menu">
								<li><a href="homthu.html"><i class="far fa-envelope"
										style="font-size: 17px"></i> Hòm thư</a></li>
								<li><a href="<c:url value="/xnmatkhau"/>"><i
										class="fas fa-tools" style="font-size: 17px"></i> Đổi mật khẩu</a></li>
								<li role="separator" class="divider"></li>
								<li><a href="<c:url value="/dangxuatad"/>"><i
										class="far fa-times-circle"></i>&nbsp;</span> Thoát</a></li>
							</ul>
						</c:if></li>
				</ul>
			</nav>
			<h1>
				<span class="glyphicon glyphicon-folder-open addtop"
					aria-hidden="true"></span>&nbsp;&nbsp;Thêm danh mục
			</h1>
			<div id="sub-main">
				<div class="row">
					...
					<div class="hidden-xs col-sm-5 col-md-4 col-lg-3 text-right">
						<div class="timecount">
							19:11:22 <small>(12/11/2019)</small>
						</div>
					</div>
				</div>
				<div class="row margin0 space-top">
					<div class="option-h4 text-justify">
						<h4>Thêm danh mục</h4>
						<form:form action="themdanhmuc" modelAttribute="categorys"
							method="POST" onsubmit="return validate()" name="myForm">

							<div class="tendm">
								<label>Tên danh mục</label><br>
								<form:input type="text" class="texttendm" id="name"
									placeholder=" Nhập Tên danh mục cần thêm" path="type" />
							...
							<input
								style="color: white; width: 120px; height: 50px; background: #5bc0de; margin-left: 200px; border-radius: 3px;"
								type="submit" name="signup" id="signup" value="Thêm dữ liệu" />
						...
						<div class="btntrolai"
							...
							<a href="<c:url value="/danhmuc"/>" style="color: white">TRỞ
								LẠI</a>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		function validate() {
			...
			if (document.myForm.active.value == "") {
