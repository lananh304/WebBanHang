<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<header id="wn__header"
			...
			<div class="container-fluid">
				<div class="row">
					<div class="ctl00_Header1_ucLogout_dLog language "  >

						<a href="vi"><img src="https://cdn0.fahasa.com/skin/frontend/ma_vanese/fahasa/images/default.svg" alt=""  id="imgUS" style="width: 20px;height: 15px;margin-left: 1237px;margin-top: 0%;margin-bottom: 0%" title="Vietnamese" ></a>
					...
					<div class="ctl00_Header1_ucLogout_dLog language "  >
						 ...
						 <a href="en"><img src="https://cdn0.fahasa.com/skin/frontend/ma_vanese/fahasa/images/english.svg" alt="" id="imgVi" style="width: 20px;height: 15px;margin-top: -3.7%;margin-bottom: 0%;margin-left: 1260px" title="English"></a>
									...
									<li>
										<div class="row_1">
											<div class="col-sm-12">
												...
												<form class="navbar-form navbar-left" role="search" action="${pageContext.request.contextPath }/timkiem" method="get">
													<div class="input-group">
										
														<input type="text" class="form-control" id="tags"
															placeholder="<spring:message code="timkiem" text="default text" />" name="text"  value="" onchange='this.form.submit()'> <span
				...
				<span><a href="<c:url value="/myaccount"/>"><spring:message code="capnhap" text="default text" /></a></span>
								...
								<c:if test="${ not empty LoginInfo }">
							                       ...
							                       <div class="goi" style="margin-left: 30px; margin-top: 5px">
							                           <p><spring:message code="chao" text="default text" /> ${LoginInfo.username }</p>
