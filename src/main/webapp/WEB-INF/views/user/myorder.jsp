						...
						<div class="bradcaump__inner text-center">
							<nav class="bradcaump-content">
								<a class="breadcrumb_item" href="index.html">Trang chủ</a> <span
									...
									class="breadcrumb_item active">Đơn hàng của tôi</span>
							</nav>
						</div>
					</div>
				</div>
						...
						<form action="#">
							<div class="table-content wnro__table table-responsive">
								<table>
									<thead>
										<tr class="title-top">
											<th class="product-subtotal" style="width: 30px" >Mã đơn hàng</th>
											<th class="product-name">Đơn giá</th>
											<th class="product-price">Thời gian</th>
											<th class="product-quantity">Trạng thái</th>
											<th class="product-subtotal" style="width: 30px">Chi tiết</th>
									...
									<tbody>
											...
											<c:forEach var="item" items="${orders}" varStatus="index">
												...
												<tr>
													...
													<td class="product-price"><span class="">${item.total}00
															₫</span></td>
																<td class="product-price"><span class="">${item.date}
															</span></td>
																<td class="product-price"><span class="">${item.trangthai}
															</span></td>
												
													
							<td><a title="Xem chi tiết" href = "<c:url value="/xemmyorder/${item.id}"/>"><i class="fas fa-eye" style="font-size: 20px; color: #03A9F4 "></i>   </a>
						</td>
												</tr>
											</c:forEach>
