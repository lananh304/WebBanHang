   ...
   <div class="mainn">
        ...
        <section class="sign-in" style="width:1500px;margin-left: -100px">
            <div class="containerr" >
                <div class="signin-content" style="height: 570px">
                    <div class="signin-image">
                        <figure><img src="<c:url value="/assets/user/images/form/forgot-password.jpg"/>" alt="sing up image" ></figure>
<!--                        <a href="#" class="signup-image-link">Create an account</a>-->
                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">Khôi phục mật khẩu</h2>
                        <p style="margin-bottom: 20px;margin-top: -20px">Nếu bạn quên mật khẩu, nhập địa chỉ email của bạn vào khung này và nhấp Khôi phục mật khẩu.

                            Bạn sẽ nhận được mật khẩu mới và một liên kết để đăng nhập. Bạn có thể thay đổi mật khẩu sau đó.</p>
                       
                         <c:forEach var="item" items="${status1}" varStatus="index">
                        <p style="margin-bottom: 5px ; color: red;">${item}</p>
                        </c:forEach>
                        <form method="post" class="register-form" id="login-form" action="sendEmail" enctype="multipart/form-data"  onsubmit="return validate()" name="myForm">
                            <div class="form-group">
                                <label for="your_name"><i class="fas fa-envelope"></i></label>
                                <input type="text" name="mailTo" id="receiverMail" placeholder="Email"/>
                                        
                            </div>
                             <span id="emaill" class="er"></span>
                         
                            <div class="form-group form-button">
                                <input type="submit" name="signin" id="signin" class="form-submit" value="Khôi phục mật khẩu"/>
                            </div>
                        </form>
...
<script type="text/javascript">
	...
	function validate() {
		...
		var emailID = document.myForm.receiverMail.value;
		atpos = emailID.indexOf("@");
		dotpos = emailID.lastIndexOf(".");

		if (document.myForm.receiverMail.value == "") {
			showError('emaill', 'Bạn không thể để trống dữ liệu này');
			document.myForm.receiverMail.focus();
			return false;
		} else {
		...
		if (!mailformat.test(document.myForm.receiverMail.value)) {
