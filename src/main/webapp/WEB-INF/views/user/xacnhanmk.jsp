    ...
    <div class="mainn">
        ...
        <section class="signup">
                ...
                <div class="signup-content">
                   <div class="signin-image">
                    ...
                    <div class="signup-form">
                        ...
                        <h2 class="form-title">Xác nhận mật khẩu</h2>
                      <c:url value="/matkhau" var="matkhau" />
                        <form:form action="" modelAttribute="mypass"  name="myForm" method="POST"
			onsubmit="return validate()" class="register-form" id="register-form">  
                            ...
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-lock"></i></label>
                                <form:input type="password" name="name" id="name" placeholder="Mật khẩu cũ" path="password" />  
                        ...
                        <p style="margin-bottom: 20px; color: red;">${item}</p>
                            ...
                            <span id="na" style="color: red"></span>
                                ...
                                <div class="form-group form-button" style="width: 200px;height: 75px">
                            <li id="signup" class="form-submit"><a href="<c:url value="/myaccount"/>"  style="color: white">Trở lại </a></li>
                            </div>  
                            <div class="form-group form-button" style="margin-left: 150px;margin-top: -100px;height: 75px">
