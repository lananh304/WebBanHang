        ...
        <section class="sign-in"   >
            <div class="containerr">
                <div class="signin-content" >
                    ...
                    <div class="signin-form" style=" text-align:center; vertical-align:middle;margin-left: 230px">
                        <h2 class="form-title" style="color: #1da0f2">Đặt hàng thành công</h2>
                        <form method="POST" class="register-form" id="login-form">
                            <div class="form-group">
                         
                              <img src="   <c:url value="/assets/user/images/bg/tich-xanh-icon.png"/>" alt="sing up image" style="width: 150px;height: 150px" >
                            </div>

                            <div class="form-group form-button">
                                <a  name="signin" id="signin" class="form-submit" value="Tiếp tục mua hàng" href="<c:url value="/"/>" style="color: white;">Tiếp tục mua hàng</a>
         <a  name="signin" id="signin" class="form-submit" value="Đơn hàng của tôi" href="<c:url value="/myorder"/>" style="color: white;">Đơn hàng của tôi</a>
                            </div>
                        </form>
