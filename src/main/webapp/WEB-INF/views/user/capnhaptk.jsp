...
<%@include file="layouts/header.jsp"%>	
                ...
                <div class="col-lg-12">
                    <div class="bradcaump__inner text-center">
                        ...
                        <nav class="bradcaump-content1">
                            ...
                            <span class="breadcrumb_item active">Cập nhập tài khoản</span>
                        </nav>
                    </div>
                </div>
            </div>
    ...
    <div class="mainn">
        ...
        <section class="signup">
            <div class="containerr" style="width: 1100px">
                <div class="signup-content" >
                    <div class="signup-form">
                        ...
                        <form:form action="updateUser" modelAttribute="myaccount"  name="myForm" method="POST"
			onsubmit="return validate()" class="register-form" id="register-form">  
                      
                         <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <form:input type="hidden" name="name" id="" placeholder="Mã tài khoản" path="id"  />  
                            ...
                            <div class="form-group">
                                ...
                                <form:input type="email" name="email" id="email" placeholder="Email" path="email" readonly="true" />
                            </div>
					...
					id="da" class="er"></span>
                            ...
                            <div class="form-group form-button">
                                <form:input type="submit" name="signup" id="signup" class="form-submit" value="Cập nhập tài khoản" path=""/>
                            </div>
                              <div class="form-group form-button" style="margin-left: 230px;margin-top: -100px;width: 200px">
                            <li id="signup" class="form-submit"><a href="<c:url value="/xnmatkhau"/>"  style="color: white">Đổi mật khẩu </a></li>
                            </div>
                        </form:form >
                    </div>
                    <div class="signup-image">
                 
                        <figure><img src="<c:url value="/assets/user/images/form/update.jpg"/>" alt="sing up image"></figure>
