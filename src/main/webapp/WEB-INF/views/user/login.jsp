            ...
            <div class="containerr">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="<c:url value="/assets/user/images/form/signin-image.jpg"/>" alt="sing up image" ></figure>
                        <a href="<c:url value="/dangki"/>" class="signup-image-link"> Đăng kí tài khoản</a>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <p style="margin-bottom: 20px; color: red;">${item}</p>
                         ...
                         <form:form action="dangnhap" modelAttribute="user" method="POST" class="register-form" id="login-form" onsubmit="return validate()" name="myForm">  
                      
                    
                            <div class="form-group">
                                <label for="your_name"><i class="zmdi zmdi-email"></i></label>
                                <form:input type="email" name="your_name" id="email" placeholder="Email" path="email"/>
                            ...
                            <div class="form-group">
                                ...
                                <form:input type="password" name="your_pass" id="passs" placeholder="Mật khẩu" path="password"/>
                            ...
                            <div class="form-group">
                                ...
                                <label for="remember-me" class="label-agree-term"><span><span></span></span>Ghi nhớ thông tin</label>
                            </div>
                            <div class="form-group d1">
                                <a href="<c:url value="/quenmk"/>" class="signup-image-link">Quên mật khẩu?</a>
                            </div>
                            <div class="form-group form-button">
                                <form:input type="submit" name="signin" id="signin" class="form-submit" value="Đăng nhập" path=""/>
                            </div>
                        </form:form>
                        <div class="social-login">
                            ...
                            <ul class="socials">
                                ...
                                <li><a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/WebBanSach/dangnhap-google&response_type=code
		&client_id=658267149293-2pfb8o0cghab7mn6d8f92cait74rdrts.apps.googleusercontent.com&approval_prompt=force"><i class="display-flex-center zmdi zmdi-google"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script
	...
	<script>
	   function search_product() {
			$.ajax({
				url : "http://localhost:8080/WebBanSach/dangnhap" + $(this).attr("href"),
				success : function() {
					location.reload();
				}
			});
