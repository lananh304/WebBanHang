                ...
                <div class="col-lg-12">
                    <div class="bradcaump__inner text-center">
                        ...
                        <nav class="bradcaump-content1">
                            ...
                            <span class="breadcrumb_item active">Đổi mật khẩu</span>
                        </nav>
                    </div>
                </div>
            </div>
            ...
            <div class="containerr">
                <div class="signup-content">
                   <div class="signin-image">
                         <figure><img  src="<c:url value="/assets/user/images/form/reset.jpg"/>" alt="sing up image" ></figure>
                   
                    </div>
                    <div class="signup-form">
                                        
                        <h2 class="form-title">Đổi mật khẩu</h2>
                      <c:url value="/matkhau" var="matkhau" />
                        <form:form action="matkhau" modelAttribute="mypass"  name="myForm" method="POST"
			onsubmit="return validate()" class="register-form" id="register-form">  
                             <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-lock"></i></label>
                                <form:input type="hidden" name="name" id="name" placeholder="id" path="id" />  
                                
                            </div>
                      
                                <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-lock"></i></label>
                                <form:input type="hidden" name="name" id="name" placeholder="id" path="email" />  
                                
                            </div>
<!--                             <div class="form-group"> -->
<!--                                 <label for="name"><i class="zmdi zmdi-lock"></i></label> -->
<%--                                 <form:input type="password" name="name" id="name" placeholder="Mật khẩu cũ" path="" />   --%>
...
<!--                             <span id="na" style="color: red"></span> -->
                            ...
                            <div class="form-group">
                                ...
                                <form:input type="password" name="pass" id="password" placeholder="Mật khẩu mới" path="password"/>
                            </div>
                            <span id="pass" class="er"></span>
                            <div class="form-group">
                                <label for="re-pass"><i class="zmdi zmdi-lock-outline"></i></label>
                                <form:input type="password" name="re_pass" id="confirmpassword" placeholder="Xác nhận mật khẩu mới" path="" />
                            </div>
                             <span id="conpass" class="er"></span>
                            <div class="form-group form-button" style="width: 200px">
                            <li id="signup" class="form-submit"><a href="<c:url value="/xnmatkhau"/>"  style="color: white">Trở lại </a></li>
                            </div> 
                            <div class="form-group form-button" style="margin-left: 150px;margin-top: -100px">
                                <form:input type="submit" name="signup" id="signup" class="form-submit" value="Đổi mật khẩu" path=""/>
                            </div>
